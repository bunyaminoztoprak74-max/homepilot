...
export default function Page() {
  return (
    <TrustPage title="Terms" description="Terms for using HomePilot buying guides and affiliate links.">
      ...
      <p>
        As an Amazon Associate and eBay Partner Network affiliate, we may earn from qualifying purchases. Affiliate relationships do not permit us to publish fake prices, fake ratings, or fake reviews.
      </p>
    </TrustPage>
  );
}
