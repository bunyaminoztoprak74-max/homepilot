  ...
  return (
    <header className="sticky top-0 z-50 border-b border-neutral-200 bg-white/85 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 sm:px-6 lg:px-8">
        ...
        <p className="hidden text-xs font-medium text-neutral-500 lg:block">
          Expert buying guides for home products.
        </p>
        ...
        <Link className="rounded-full border border-neutral-300 px-4 py-2 text-sm font-semibold text-neutral-950 transition hover:-translate-y-0.5 hover:border-neutral-950" href="/best-air-fryers">
          Compare
        </Link>
      </div>
    </header>
